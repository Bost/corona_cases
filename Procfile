...
web: java -Xmx1024m -XX:+HeapDumpOnOutOfMemoryError -Djdk.attach.allowAttachSelf --illegal-access=permit $JVM_OPTS -cp target/corona_cases-standalone.jar clojure.main -m corona.web.core
