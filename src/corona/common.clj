...
(def ^:const case-params
  ...
  [
   ...
   {:idx  1 :kw :c                :threshold {:inc 50000     :val (int 1560e3)}}
   {:idx  2 :kw :r :listing-idx 1 :threshold {:inc 10000     :val (int 997e3)}}
   {:idx  3 :kw :d :listing-idx 2 :threshold {:inc 1000      :val (int 50e3)}}
   {:idx  4 :kw :a :listing-idx 0 :threshold {:inc 10000     :val (int 609e3)}}
   {:idx  5 :kw :a100k}
   {:idx  6 :kw :r100k}
   {:idx  7 :kw :d100k}
   {:idx  8 :kw :c100k}
