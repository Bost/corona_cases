...
(def case-params
  ...
  [{:idx  0 :kw :v                :threshold {:inc (int 1e6) :val (int 1e7)}}
   ...
   {:idx  2 :kw :c                :threshold {:inc 50000     :val (int 2260e3)}}
   {:idx  3 :kw :r :listing-idx 1 :threshold {:inc 10000     :val (int 1427e3)}}
   {:idx  4 :kw :d :listing-idx 2 :threshold {:inc 1000      :val (int 59e3)}}
   {:idx  5 :kw :a :listing-idx 0 :threshold {:inc 10000     :val (int 699e3)}}
