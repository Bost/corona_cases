...
(def ^:const case-params
  ...
  [
   ...
   {:idx  1 :kw :c                :threshold {:inc 50000     :val (int 1810e3)}}
   {:idx  2 :kw :r :listing-idx 1 :threshold {:inc 10000     :val (int 1097e3)}}
   {:idx  3 :kw :d :listing-idx 2 :threshold {:inc 1000      :val (int 51e3)}}
