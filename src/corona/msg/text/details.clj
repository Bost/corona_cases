...
(defn incidence
  ...
  [lense-fun case-kw nr-of-reports country-stats]
  ((comp
    round-nr
    (fn [diffs]
      (let [population
        ...
        (* (/ (reduce + diffs)
              population)
           1e5))))
   (deltas-case-kw (lense-fun case-kw) nr-of-reports country-stats)))
         ...
         [
          (let [nr-or-reports 7]
            ...
            {:s (lang/incidence nr-or-reports)
             ...
             :n (incidence lense-fun :n nr-or-reports ccode-stats)})
